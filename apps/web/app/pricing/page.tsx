...
import { Check, X, Sparkles, ShieldCheck, Zap, Flame, Users, ArrowRight, Star } from 'lucide-react';
          ...
          <div className="grid grid-cols-1 md:grid-cols-3 gap-8 items-stretch">
            ...
            <div className="glass-card border-2 border-primary rounded-3xl p-7 shadow-[0_0_35px_rgba(0,187,136,0.2)] relative flex flex-col justify-between space-y-6 transform scale-[1.02] bg-gradient-to-b from-primary/10 via-transparent to-transparent">
              ...
              <Link
                ...
                className="w-full py-4 rounded-xl bg-gradient-to-r from-primary to-accent-cyan text-white font-bold text-center text-xs shadow-lg hover:shadow-xl transition-all transform hover:scale-[1.01] block"
              >
                Get Started Pro
              </Link>
            </div>
            ...
            <div className="glass-card border-gradient rounded-3xl p-7 shadow-glass relative flex flex-col justify-between space-y-6 hover:translate-y-[-4px] transition-transform">
              <div className="space-y-5">
                <div>
                  ...
                  <p className="text-xs text-gray-400 mt-1">
                    Multi-client workspace for agencies & talent managers
                  </p>
                </div>
                ...
                <div className="flex items-baseline space-x-1">
                  <span className="text-4xl font-black text-white">
                    {isAnnual
                      ? `₹${currentAgencySeats.priceYearly.toLocaleString()}`
                      : `₹${currentAgencySeats.priceMonthly.toLocaleString()}`}
                  </span>
                  <span className="text-xs text-gray-400 font-bold">
                    {isAnnual ? '/ year' : '/ month'}
                  </span>
                ...
                <div className="border-t border-white/5 pt-4 space-y-3 text-xs text-gray-300">
                  <div className="flex items-center space-x-2.5">
                    <Check className="w-4 h-4 text-primary flex-shrink-0" />
                    <span>
                      <strong>{currentAgencySeats.seats} Client Accounts</strong> Managed
                    </span>
                  </div>
                  <div className="flex items-center space-x-2.5">
                    <Check className="w-4 h-4 text-primary flex-shrink-0" />
