...
export default function InboxPage() {
  const [viewMode, setViewMode] = useState<'reply-desk' | 'direct'>('reply-desk');
        ...
        <div className="flex flex-col sm:flex-row items-start sm:items-center justify-between gap-3 pb-3 border-b border-white/5">
          <div>
            ...
            <p className="text-xs text-gray-400">
              Manage high-intent buyer inquiries with AI Smart Replies and live direct message
              threads.
            </p>
          </div>
          ...
          <div className="flex items-center bg-white/5 border border-white/10 p-1 rounded-xl">
            ...
            >
              ...
              <span>Reply Desk (AI Queries)</span>
            </button>
            <button
            ...
            >
              ...
              <span>Direct Threads ({conversations.length})</span>
            </button>
          </div>
        </div>
